...
public class Styles {
	public static Image image = new Image("/gui/images/GSLogo.png", 200, 112.5, true, true);
	public static BackgroundSize backgroundSize = new BackgroundSize(200, 112.5, false, false, false, false);
	public static BackgroundPosition bPosition = new BackgroundPosition(Side.LEFT, 100, false, Side.TOP, 23.75, false);
	...
	public static Background BACKGROUNDIMAGE = new Background(bGround);
